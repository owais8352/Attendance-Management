    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/owais/OneDrive/Desktop/Attendance-Management-System-using-Face-Recognition-main/Attendace_management_system/Attendance/ManuallyAttendance/'+DB_table_name+'.csv'
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/owais/OneDrive/Desktop/Attendance-Management-System-using-Face-Recognition-main/Attendace_management_system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/owais/OneDrive/Desktop/Attendance-Management-System-using-Face-Recognition-main/Attendace_management_system/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'owais':
            if password == 'owais1234':
                ...
                cs = 'C:/Users/owais/OneDrive/Desktop/Attendance-Management-System-using-Face-Recognition-main/Attendace_management_system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
